...
// XGBoost risk-prediction models load lazily on the first prediction call
// (see ensureModelsLoaded in utils/caseRiskPredictions.js) so the 6.4MB
// fetch stays off the critical startup path.
